...
@section('morejs')
    ...
    <script>
        ...
        function getBtn(stat) {
            ...
            switch (stat) {
                case 0:
                    ...
                    break;
                case 1:
                    btn = '<a class="changeStatus font-bold cursor-pointer p-2 bg-blue-600 rounded-md text-white transition-all duration-300  hover:bg-blue-400" data-text="Terima" data-status="2">Terima</a>' +
                        '<a class="changeStatus font-bold cursor-pointer p-2 bg-red-600 rounded-md text-white transition-all duration-300  hover:bg-red-400" data-text="Tolak" data-status="6">Tolak</a>';
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    btn = '<a class="changeStatus font-bold cursor-pointer p-2 bg-blue-600 rounded-md text-white transition-all duration-300  hover:bg-blue-400" data-text="Proses" data-status="4">Proses</a>';
                    break;
                case 4:
                    btn = '<a class="changeStatus font-bold cursor-pointer p-2 bg-blue-600 rounded-md text-white transition-all duration-300  hover:bg-blue-400" data-text="Kirim" data-status="5                   ">Dikirim</a>';
                    break;
                case 5:
        ...
        function showDatatable() {
            ...
            datatable('table', '{{route('transaksi.datatable')}}', colums, null,['2','DESC'])
